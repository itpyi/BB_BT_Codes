...
--------------
    ...
    python testSCwithFramework_ler_vs_rounds.py --rounds 1 2 3 4 --p-list 0.006 --shots 5000 --max-errors 50 --plot-per-round bb_per_round.png
    ...
    for rounds in rounds_list:
        for p in p_list:
            ...
            if _os.getenv("QEC_DEBUG_DIAGRAM"):
                ...
                with open("surfacecode_circuit_debug_diagram.svg", "w") as f:
                    f.write(str(diagram))
                circuit.to_file("surfacecode_circuit_debug_circuit.stim")
